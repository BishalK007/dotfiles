...
# an Eww widget (brightness_dropdown) with position logic and timing.
#
# Dependencies:
#   - hyprctl
#   - jq
...
show_widget_till_file="/tmp/shm/brightness-widget-show-dropdown-till"
...
# Determine the eww command based on the action
case $action in
    open)
