    ...
    >
      <centerbox cssName="centerbox">
        ...
        >
          ...
          <button
            onClicked={() => {
              ...
              if (fileManager) {
                ...
                logger.error("FILE_MANAGER environment variable not set");
              }
            }}
           ...
           ************ Calendar Widget ************
           */}
          <CalendarWidget dateFormat="DdMmmYyyy" dayFormat="ABBREVIATED" />
        </box>
        <box />
        <box
          orientation={Gtk.Orientation.HORIZONTAL}
