...
//       spacing={0}
//       cssClasses={["sound-and-brightness", "sound-and-brightness-box"]}
...
//         <popover autohide={true} cssClasses={["sound-popover"]}>
//           <SoundPopup />
//         </popover>
//       </menubutton>
//       <menubutton
...
//         <popover cssClasses={["brightness-popover"]}>
//           <BrightnessPopup />
//         </popover>
//       </menubutton>
//     </box>
...
export default function SoundAndBrightness() {
  return (
    <menubutton valign={Gtk.Align.CENTER} cssClasses={["sound-and-brightness"]}>
      <box
        orientation={Gtk.Orientation.HORIZONTAL}
        spacing={0}
        cssClasses={["sound-and-brightness", "sound-and-brightness-box"]}
      ...
      >
        <label
          label={soundIcon()}
          cssClasses={["sound-and-brightness-icon", "sound-icon"]}
        />
        <label
          cssClasses={["sound-and-brightness-icon", "brightness-icon"]}
          label={brightnessIcon()}
        />
      </box>
      <popover autohide={true} cssClasses={["brightness-popover"]}>
        <Popup />
      </popover>
    </menubutton>
  );
